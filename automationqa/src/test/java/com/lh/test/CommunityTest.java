...
import com.lh.utils.DataProviders;
...
public class CommunityTest extends BaseTestClass {
	...
	@Test(dataProvider = "CommunityDataProvider", dataProviderClass=DataProviders.class, priority = 1)
	...
	public void verifyGroupNameFieldIsRequired() {
		...
		communityAssert.assertTrue(communityPage.GroupNameFieldIsRequired(communityData.get(ERROR_MESSAGE_GROUP)));
	}
